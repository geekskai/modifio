export default function About() {
  return (
    <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8">
      <p>
        Introducing MediaModify, the ultimate multimedia conversion powerhouse
      ...
      <div className="space-y-2">
        ...
        <p>
          Access MediaModify from any device with an internet connection.
      ...
      <div className="space-y-2">
        <h2 className="text-xl md:text-2xl font-medium text-muted-foreground">
          🌟 It's Free, It's Powerful, It's MediaModify:
        </h2>
        <p>
